...
const { getTestSuitePaths, distributeTestsByWeight, distributeTestsBySpecGroups } = require('./test-suites');
const {
  formatTime,
  generateWeightsFile,
  collectResults
...
async function start() {
  ...
  const threads = settings.testSuitesPathGroups ? distributeTestsBySpecGroups(testSuitePaths) : distributeTestsByWeight(testSuitePaths);
